...
// ============================================================
// 3. VM errors include source location (MLabError)
// ============================================================
...
TEST_P(DebugPhase1Test, WhatIsRawMessage)
{
    ...
    MLabError err("divide by zero", 10, 5, "calc");
...
{
    // Verify MLabError is still catchable as std::runtime_error
