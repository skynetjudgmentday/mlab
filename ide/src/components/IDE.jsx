...
export default function REPL({ engine: engineProp, status: statusProp, vfsAdapters, onLocalMount }) {
  ...
  // Inline mark SVG [nₖ] from brand/ — uses currentColor so
  // the surrounding <span style={{color:...}}> controls the fill.
  const NumkitMark = ({size=22}) => (
    <svg viewBox="0 0 260 160" height={size} role="img" aria-label="numkit" style={{display:"block"}}>
      <g fill="currentColor">
        <g transform="translate(-9.304, 121.6)"><path transform="scale(0.08, -0.08)" d="M388 1328V-104Q388 -135 404 -148.5Q420 -162 453 -162H626Q683 -162 683 -209Q683 -230 669 -242.5Q655 -255 626 -255H237Q197 -255 179.5 -236Q162 -217 162 -177V1400Q162 1441 179.5 1460Q197 1479 237 1479H626Q655 1479 669 1466Q683 1453 683 1432Q683 1385 626 1385H453Q420 1385 404 1372Q388 1359 388 1328Z"/></g>
        <g transform="translate(42.936, 121.6)"><path transform="scale(0.08, -0.08)" d="M471 902V793Q574 881 650 922Q740 970 821 970Q944 970 1012 887.5Q1080 805 1095 668L1151 163Q1154 130 1162 115Q1170 100 1189 94L1224 84Q1243 77 1252 66.5Q1261 56 1261 41Q1261 22 1248 11Q1235 0 1206 0H816Q761 0 761 44Q761 71 792 84L830 94Q849 101 859.5 116Q870 131 866 163L814 627Q804 714 769.5 758Q735 802 668 802Q626 802 579.5 780Q533 758 481 714L471 705V160Q471 129 480 115Q489 101 507 94L543 84Q575 71 575 44Q575 0 519 0H133Q105 0 92 11Q79 22 79 41Q79 56 87.5 66.5Q96 77 115 84L155 94Q173 101 181.5 115Q190 129 190 160V733Q190 759 182.5 770Q175 781 158 784L105 788Q87 792 79 801Q71 810 71 824Q71 841 80.5 851Q90 861 117 871L303 939Q341 953 364 959Q387 965 408 965Q439 965 455 947.5Q471 930 471 902Z"/></g>
        <g transform="translate(149.896, 156.8)"><path transform="scale(0.044, -0.044)" d="M130 0Q101 0 90 11Q79 22 79 41Q79 56 87.5 66.5Q96 77 116 84L155 94Q173 101 181.5 115Q190 129 190 160V1255Q190 1280 182.5 1291Q175 1302 158 1305L105 1309Q87 1314 79 1323Q71 1332 71 1346Q71 1362 80.5 1372Q90 1382 117 1392L303 1460Q341 1474 364 1480.5Q387 1487 408 1487Q439 1487 455 1469.5Q471 1452 471 1423V502L797 768Q832 796 828.5 820.5Q825 845 786 857L751 866Q732 872 725 881Q718 890 718 905Q718 925 732 936Q746 947 771 947H1121Q1145 947 1159.5 936Q1174 925 1174 907Q1174 888 1162 876Q1150 864 1112 855Q1061 844 1021.5 822Q982 800 922 752L766 627L1090 159Q1114 126 1132 112.5Q1150 99 1183 88Q1204 78 1214.5 66Q1225 54 1225 39Q1225 21 1210.5 10.5Q1196 0 1172 0H764Q742 0 729 11Q716 22 716 41Q716 54 723 63Q730 72 746 78L778 87Q806 95 808 111.5Q810 128 782 167L571 472L471 391V160Q471 129 480 115Q489 101 507 94L543 84Q575 71 575 44Q575 0 519 0Z"/></g>
        <g transform="translate(200.904, 121.6)"><path transform="scale(0.08, -0.08)" d="M317 -105V1327Q317 1358 301 1371.5Q285 1385 252 1385H79Q22 1385 22 1432Q22 1453 36 1465.5Q50 1478 79 1478H468Q508 1478 525.5 1459Q543 1440 543 1400V-177Q543 -218 525.5 -237Q508 -256 468 -256H79Q50 -256 36 -243Q22 -230 22 -209Q22 -162 79 -162H252Q285 -162 301 -149Q317 -136 317 -105Z"/></g>
      </g>
    </svg>
  );
  ...
  return (
    <div style={{display:"flex",flexDirection:"column",height:"100vh",width:"100%",background:C.bg0,color:C.text,fontFamily:FONT,fontSize:13,overflow:"hidden"}}>
      <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"5px 12px",background:C.bg1,borderBottom:`1px solid ${C.border}`,flexShrink:0,zIndex:30,gap:8}}>
        <div style={{display:"flex",alignItems:"center",gap:6,flexShrink:0,color:C.accent}}><NumkitMark size={22}/><span style={{fontSize:15,fontWeight:700,letterSpacing:-0.5,fontFamily:FONT_UI}}>mIDE</span><span style={{fontSize:9,color:C.textMuted}}>v2.5</span></div>
