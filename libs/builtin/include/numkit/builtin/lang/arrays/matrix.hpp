...
Value zeros(Allocator &alloc, size_t rows, size_t cols = 1, size_t pages = 0);
Value ones(Allocator &alloc, size_t rows, size_t cols = 1, size_t pages = 0);
...
Value cumprod(Allocator &alloc, const Value &x, int dim = 0);
Value cummax (Allocator &alloc, const Value &x, int dim = 0);
Value cummin (Allocator &alloc, const Value &x, int dim = 0);
...
Value diff(Allocator &alloc, const Value &x, int n = 1, int dim = 0);
...
Value anyOf(Allocator &alloc, const Value &x, int dim = 0);
Value allOf(Allocator &alloc, const Value &x, int dim = 0);
