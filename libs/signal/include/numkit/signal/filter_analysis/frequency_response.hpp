...
freqz(Allocator &alloc, const Value &b, const Value &a, size_t npts = 512);
...
std::tuple<Value, Value>
phasez(Allocator &alloc, const Value &b, const Value &a, size_t npts = 512);
...
std::tuple<Value, Value>
grpdelay(Allocator &alloc, const Value &b, const Value &a, size_t npts = 512);
